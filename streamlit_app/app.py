...
if st.button("Get Recommendations"):
    if not (customer_id.startswith("C") and customer_id[1:].isdigit() and 1000 <= int(customer_id[1:]) <= 10999):
        st.error("Please enter a valid Customer ID between C1000 and C10999.")
    else:
